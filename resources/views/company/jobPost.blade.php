...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Job Posting Form') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('company_job_post_save') }}" >
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="job_description" class="form-control @error('job_description') is-invalid @enderror" name="job_description"></textarea>
                        ...
                        <div class="form-group row">
                            <label for="location" class="col-md-4 col-form-label text-md-right">{{ __('Job Location') }}</label>
